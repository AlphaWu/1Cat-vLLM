...
![1Cat-vLLM 开源交流群2](docs/group2.jpg)
...
```bash
python -m pip install "https://github.com/1CatAI/1Cat-vLLM/releases/download/v0.0.2/vllm-0.0.2.dev0+g55573923a.d20260321.cu128-cp312-cp312-linux_x86_64.whl"
```
